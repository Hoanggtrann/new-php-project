        ...
        <div class="col-12">
            <nav class="navbar navbar-expand-lg  blur blur-rounded top-0  z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
                <div class="container-fluid px-0">
                    ...
                    <a href="./login" class="btn btn-sm  bg-gradient-primary  btn-round mb-0 ms-auto d-lg-none d-block">Đăng
                        nhập</a>
                    ...
                    <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
                        ...
                        <ul class="navbar-nav d-lg-block d-none">
                            <li class="nav-item">
                                <a href="./login" class="btn btn-sm  bg-gradient-primary  btn-round mb-0 me-1" onclick="smoothToPricing('pricing-soft-ui')">Đăng nhập</a>
                            </li>
                        </ul>
                    </div>
                </div>
